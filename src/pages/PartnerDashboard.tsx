      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center">
            ...
            {partnerCompany.name} - Partneri felület
          </h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-base font-medium text-gray-900 dark:text-white">
                  {partnerCompany.tax_number || 'Nincs megadva'}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-base font-medium text-gray-900 dark:text-white">
                  {partnerCompany.address ? (
                    <>
                      {partnerCompany.address}, {partnerCompany.postal_code} {partnerCompany.city}, {partnerCompany.country}
                    </>
                  ) : (
                    'Nincs megadva'
                  )}
          ...
          <div>
            <div className="space-y-3">
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Kapcsolattartó</p>
                <p className="text-base font-medium text-gray-900 dark:text-white">
                  {partnerCompany.contact_person || 'Nincs megadva'}
                </p>
              </div>
              
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Elérhetőség</p>
                <p className="text-base font-medium text-gray-900 dark:text-white">
                  {partnerCompany.phone || 'Nincs megadva'} • {partnerCompany.email || 'Nincs megadva'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className={`w-2 h-2 rounded-full ${
                partnerCompany.status === 'active' ? 'bg-green-500' : 
                partnerCompany.status === 'suspended' ? 'bg-amber-500' : 'bg-red-500'
              } mr-2`}></div>
              <span className="text-sm text-gray-600 dark:text-gray-400">
                Állapot: {partnerCompany.status === 'active' ? 'Aktív' : 
                          partnerCompany.status === 'suspended' ? 'Felfüggesztve' : 'Inaktív'}
              </span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              {partnerCompany.payment_terms && (
                <span className="text-sm text-gray-600 dark:text-gray-400">
                  Fizetési feltételek: {partnerCompany.payment_terms === 'immediate' ? 'Azonnali' : 
                                       partnerCompany.payment_terms === 'net15' ? 'Net 15' :
                                       partnerCompany.payment_terms === 'net30' ? 'Net 30' : 'Net 60'}
                </span>
              )}
            </div>
          </div>
